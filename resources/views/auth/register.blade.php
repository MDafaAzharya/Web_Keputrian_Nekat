			...
			<div class="d-flex justify-content-center form_container">
				<form action="{{ route('actionregister') }}" method="post">
                    ...
                    <div class="input-group mb-3">
						...
						<input type="text" name="name" class="form-control input_user" value="" required="" placeholder="Username">
					</div>
					<div class="input-group mb-3">
						<div class="input-group-append">
					...
					<div class="input-group mb-2">
						...
						<button type="submit" name="submit" id="submit" class="btn login_btn">Register</button>
					</div>
				</form>
			</div>
			<div class="mt-4">
                <div class="d-flex justify-content-center links">
                    Sudah punya Akun? <a href="/login" class="ml-2">Login</a>
                </div>
            </div>
		</div>
	</div>
