...
<body>
    ...
    <div class="container-fluid px-4">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
            <a class="nav-link mx-md-3" href="/profile">Profile</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="/report">Data Laporan</a>
            </li>
           
        </ul>
        <button type="button" class="logout_button" data-bs-toggle="modal" data-bs-target="#logoutModal">Logout</button>
        </div>
    </div>
    </nav>
